...
<main>
    ...
    <section class="bg-gray-100">
        <div class="container pt-24 pb-24 lg:pb-40">
            <p class="tagline">Meios de contato</p>
            <h1 class="section-title text-black mb-12">Contate-se conosco</h1>
            <div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-x-12 gap-y-8 lg:gap-y-0">
    ...
    <section class="bg-gray-100 lg:bg-blue-300 relative">

        <div class="container bg-blue-300 lg:bg-transparent rounded-xl lg:rounded-none py-12 px-12 lg:px-0">
            <div class="lg:w-5/12">
        ...
        <div class="min-h-[400px] absolute w-full lg:right-0 lg:w-6/12 xl:w-7/12 z-10 lg:top-[-25%] shadow-lg rounded-xl">
    ...
    <div class="bg-gray-100 py-60 lg:py-24"></div>
