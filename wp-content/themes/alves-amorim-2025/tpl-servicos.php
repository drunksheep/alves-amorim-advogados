...
<main class="bg-black">
    ...
    <section class="bg-gray-100">
        <div class="container py-36 flex flex-col flex-wrap items-center justify-center">

            <div class="lg:w-8/12 text-center mb-12">
                <p class="text-lg text-blue-300 mb-4 w-full font-bold">
                    SERVIÇOS
                </p>
            ...
            <div class="grid grid-cols-4 gap-x-10">
                ...
                <div class="service-item group hover:bg-blue-300 druation-300 transition">
                    ...
                    <div class="btn-wrapper mt-6 h-0 group-hover:h-[54px] transition-[height] duration-300 ease-in-out">
                        <a class="btn-default bg-transparent text-white border-white w-full max-w-none text-center overflow-hidden hover:bg-white hover:text-blue-300"
